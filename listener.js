 ...
 * 
// ================================================================================================
// Warning: this script is severely outdated (it comes from when some popular browsers did not have
// support multiple event listeners per-node/event). I keep it around only because I was quite
// happy with it at the time. Nowadays, you should just use the native event listeners provided by
// the DOM, or else whatever comes with your JS library of choice.
// ================================================================================================
//
